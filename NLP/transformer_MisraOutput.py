...
def get_training_dataloader(train_transform, batch_size=128, num_workers=0, shuffle=True):
    ...
    data_path = "/home/gobind/data/Cifar10_Psi8_NOISE/train"
    transform_train = train_transform
    cifar10_training = torchvision.datasets.ImageFolder(root=data_path, transform=transform_train)
...
def get_testing_dataloader(test_transform, batch_size=128, num_workers=0, shuffle=True):
    ...
    data_path = "/home/gobind/data/Cifar10_Psi8_NOISE/test"
    transform_test = test_transform
    cifar10_test = torchvision.datasets.ImageFolder(root=data_path, transform=transform_test)
...
batch_size = 128
learning_rate = 0.001
act_func = ["relu", "swish", "mish", "TACT", "mTACT"]

for i in range(4, 6):
    for j in range(len(act_func)):
        model = densenet121(activation = act_func[j])
        ...
        train_stats.to_csv(f'/home/gobind/cifar-10/NoisyData/DenseNet121_{act_func[j]}_psi8_run{i}.csv')

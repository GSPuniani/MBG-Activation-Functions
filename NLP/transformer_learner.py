...
model = TransformerXL(vocab_sz=100, ctx_len=800, n_layers=12, n_heads=8, d_model=512, d_head=64, d_inner=2048)

learn = text_classifier_learner(data, model, drop_mult=0.5)
learn.lr_find()
